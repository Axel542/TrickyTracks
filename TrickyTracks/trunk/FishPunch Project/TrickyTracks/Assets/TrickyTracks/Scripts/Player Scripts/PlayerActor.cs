...
public class PlayerActor : MonoBehaviour {
    ...
    private float cddCopy;
    private float backCooldown = 5.0f;
    private float backDownCopy;

    public Renderer kartMat;

    private AudioSource idleEngine, engineAccelerate, kartCrash, gasLeak;
    private AudioSource topEngineSpeed, explosion, tireScreech, loudCrash;
    ...
    public ParticleSystem boost1, boost2;
    ...
    private AudioSource slickSound;
    ...
    //    checkPointPosition = GameObject.Find("RespawnPoint");
      ...
      //  lockSteerTime = slickSpinOutTime;
        ...
        gasLeak = GameObject.Find("BoostSound").GetComponent<AudioSource>();
        ...
        tireScreech = GameObject.Find("TireScreechSound").GetComponent<AudioSource>();
        loudCrash = GameObject.Find("LoudCrashSound").GetComponent<AudioSource>();
        slickSound = tireScreech;
    ...
    void Update() {
        ...
        if(!gamepad.GetTriggerDown_L() && !gamepad.GetTriggerDown_R())
        {
            ...
            if (kart.physicsBody.velocity.sqrMagnitude > 810 && gamepad.GetTriggerDown_R())
        {
            if (idleEngine.isPlaying)
            {
                idleEngine.Stop();
